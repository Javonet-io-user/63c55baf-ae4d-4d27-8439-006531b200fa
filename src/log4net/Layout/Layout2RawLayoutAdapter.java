...
import log4net.Core.*;
import jio.System.*;public class Layout2RawLayoutAdapter implements IRawLayout {protected NObject javonetHandle; public Layout2RawLayoutAdapter (ILayout layout){ try {  javonetHandle = Javonet.New("Layout2RawLayoutAdapter",layout);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public Layout2RawLayoutAdapter(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
