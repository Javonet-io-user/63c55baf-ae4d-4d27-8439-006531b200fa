...
import log4net.Core.*;public class SimpleLayout extends LayoutSkeleton implements ILayout,IOptionHandler {protected NObject javonetHandle; public SimpleLayout (){  super((NObject) null); try {  javonetHandle = Javonet.New("SimpleLayout"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public SimpleLayout(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
