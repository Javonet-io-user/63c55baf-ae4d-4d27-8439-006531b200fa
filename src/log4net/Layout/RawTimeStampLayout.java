...
import log4net.Core.*;
import jio.System.*;public class RawTimeStampLayout implements IRawLayout {protected NObject javonetHandle; public RawTimeStampLayout (){ try {  javonetHandle = Javonet.New("RawTimeStampLayout");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public RawTimeStampLayout(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
