...
import jio.System.*;public class DefaultRepositorySelector implements IRepositorySelector {protected NObject javonetHandle; public DefaultRepositorySelector (Class defaultRepositoryType){ try {  javonetHandle = Javonet.New("DefaultRepositorySelector",Javonet.getType(getReturnObjectName(defaultRepositoryType).getTypeName()));javonetHandle.addEventListener("LoggerRepositoryCreatedEvent", new com.javonet.api.INEventListener() {
                    @Override
                    public void eventOccurred(Object[] objects)
                    {
                        for (LoggerRepositoryCreationEventHandler handler : _LoggerRepositoryCreatedEventListeners) {handler.Invoke(Convert(objects[0], NObject.class),Convert(objects[1], LoggerRepositoryCreationEventArgs.class));}}});} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public DefaultRepositorySelector(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
                    this.javonetHandle = handle;
                }/**
	 * Method
	 */
            public ILoggerRepository GetRepository (Assembly repositoryAssembly){ try { return ConvertToConcreteInterfaceImplementation((NObject) javonetHandle.invoke("GetRepository",repositoryAssembly));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * Method
	 */
	 ...
	 * Method
	 */
            public ILoggerRepository CreateRepository (Assembly repositoryAssembly,Class repositoryType){ try { return ConvertToConcreteInterfaceImplementation((NObject) javonetHandle.invoke("CreateRepository",repositoryAssembly,Javonet.getType(getReturnObjectName(repositoryType).getTypeName())));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * Method
	 */
	 ...
	 * Method
	 */
            public ILoggerRepository CreateRepository (Assembly repositoryAssembly,Class repositoryType,java.lang.String repositoryName,java.lang.Boolean readAssemblyAttributes){ try { return ConvertToConcreteInterfaceImplementation((NObject) javonetHandle.invoke("CreateRepository",repositoryAssembly,Javonet.getType(getReturnObjectName(repositoryType).getTypeName()),repositoryName,readAssemblyAttributes));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * Method
	 */
            public void AliasRepository (java.lang.String repositoryAlias,ILoggerRepository repositoryTarget){ try { javonetHandle.invoke("AliasRepository",repositoryAlias,repositoryTarget);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }/**
	 * Event
	 */
