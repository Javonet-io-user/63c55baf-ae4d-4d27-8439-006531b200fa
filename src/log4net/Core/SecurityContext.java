...
import jio.System.*;public abstract class SecurityContext {protected NObject javonetHandle; public SecurityContext(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
