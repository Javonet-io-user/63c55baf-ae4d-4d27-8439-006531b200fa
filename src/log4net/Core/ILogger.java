...
import jio.System.*;public interface ILogger { public void Log (Class callerStackBoundaryDeclaringType,Level level,NObject message,jio.System.Exception exception);public void Log (LoggingEvent logEvent);public java.lang.Boolean IsEnabledFor (Level level);}