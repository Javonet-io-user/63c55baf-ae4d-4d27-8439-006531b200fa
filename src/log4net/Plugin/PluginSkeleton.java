...
import log4net.Repository.*;public abstract class PluginSkeleton implements IPlugin {protected NObject javonetHandle; /**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public java.lang.String getName (){ try { return  (java.lang.String) javonetHandle.get("Name");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return "";} }public PluginSkeleton(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
