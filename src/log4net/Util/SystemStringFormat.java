...
import jio.System.*;public class SystemStringFormat {protected NObject javonetHandle; public SystemStringFormat (IFormatProvider provider,java.lang.String format,NObject[] args){ try {  javonetHandle = Javonet.New("SystemStringFormat",provider,format,new Object[] {args});} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public SystemStringFormat(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
