...
import log4net.Core.*;public class DenyAllFilter extends FilterSkeleton implements IFilter {protected NObject javonetHandle; public DenyAllFilter (){  super((NObject) null); try {  javonetHandle = Javonet.New("DenyAllFilter"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public DenyAllFilter(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
