...
import log4net.Core.*;public class BufferingForwardingAppender extends BufferingAppenderSkeleton implements IAppenderAttachable {protected NObject javonetHandle; /**
	 * GetProperty
	 */
            public AppenderCollection getAppenders (){ try { return new AppenderCollection((NObject)javonetHandle.get("Appenders"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }public BufferingForwardingAppender (){  super((NObject) null); try {  javonetHandle = Javonet.New("BufferingForwardingAppender"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public BufferingForwardingAppender(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
