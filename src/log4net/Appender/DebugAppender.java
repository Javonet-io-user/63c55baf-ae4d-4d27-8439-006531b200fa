...
import log4net.Layout.*;public class DebugAppender extends AppenderSkeleton {protected NObject javonetHandle; /**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public java.lang.Boolean getImmediateFlush (){ try { return javonetHandle.get("ImmediateFlush");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return false;} }public DebugAppender (){  super((NObject) null); try {  javonetHandle = Javonet.New("DebugAppender"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public DebugAppender (ILayout layout){  super((NObject) null); try {  javonetHandle = Javonet.New("DebugAppender",layout); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public DebugAppender(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
