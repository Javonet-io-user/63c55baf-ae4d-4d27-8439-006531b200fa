...
import log4net.Core.*;
import log4net.Util.*;public class LocalSyslogAppender extends AppenderSkeleton implements IOptionHandler {protected NObject javonetHandle; /**
	 * SetProperty
	 */
            public void setIdentity (java.lang.String value){ try { javonetHandle.set("Identity",value);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }/**
	 * GetProperty
	 */
	 ...
	 * GetProperty
	 */
            public SyslogFacility getFacility (){ try { return SyslogFacility.valueOf(((NEnum) javonetHandle.get("Facility")).getValueName());} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }public LocalSyslogAppender (){  super((NObject) null); try {  javonetHandle = Javonet.New("LocalSyslogAppender"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public LocalSyslogAppender(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
	 ...
	 * Method
	 */
            public void AddMapping (LevelSeverity mapping){ try { javonetHandle.invoke("AddMapping",mapping);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } } public enum SyslogSeverity{Emergency(0L),Alert(1L),Critical(2L),Error(3L),Warning(4L),Notice(5L),Informational(6L),Debug(7L),; private long numVal;SyslogSeverity(long numVal) {
		        this.numVal = numVal;
		    }
