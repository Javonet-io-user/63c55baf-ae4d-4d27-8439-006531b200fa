...
import jio.System.IO.*;public abstract class FileSystemInfo extends MarshalByRefObject implements ISerializable {protected NObject javonetHandle; public FileSystemInfo(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
