...
import jio.System.IO.*;public abstract class TextWriter extends MarshalByRefObject implements IDisposable {protected NObject javonetHandle; public TextWriter(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
